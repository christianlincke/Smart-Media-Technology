...
data_directory = f'TrainData/dir_data_{ARM}/'

# Get a list of all CSV files in the directory
csv_files = glob.glob(data_directory + f'dir_data_{ARM}_*.csv')
...
model = ArmModel3D.GestureModel(in_feat=num_landmarks)
...
save_path = f'../Models/'
torch.save(model.state_dict(), save_path + f'dir_model_{ARM}.pth')
